...
| **Governing specifications** | [KYA-OS Protocol Specification](https://github.com/decentralized-identity/kya-os-mcp/blob/main/SPEC.md) and [Entity Card profile](https://github.com/decentralized-identity/kya-os-mcp/blob/main/SPEC-ENTITY-CARD.md), developed by the KYA-OS project and donated to the DIF Trusted AI Agents Working Group (TAAWG), where the Protocol Specification is ratified as a DIF standard and the Entity Card profile is a work item |
